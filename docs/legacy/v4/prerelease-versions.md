...
for unsupported features. Some instructions also built a local `eufy-security-client` submodule.

V5 enrollment is closed and its SDK prerelease is private. There is no public registration or public
V5 installation channel yet.
